...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      link: "/text",
      benefits: ["92% Accuracy", "Stylometric Analysis", "Context Analysis"]
    },
    // {
  ...
  const benefits = [
    {
      ...
      description: "Our algorithms achieve over 95% accuracy in detecting AI-generated content",
      icon: CheckCircle
    },
    {
      title: "Enhanced Security",
      description: "Protect yourself from misinformation and synthetic media",
      icon: ShieldCheck
    },
    {
