// // ImageDetection.tsx All Combined
...
// ImageDetection.tsx with Debugging Output
  ...
  const checkApiHealth = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setApiStatus('offline');
        // This toast can be noisy in production, but useful for debugging
        toast({
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <div className="mt-4 p-2 bg-yellow-100 border border-yellow-400 text-yellow-800 rounded-md">
              <p className="font-bold text-sm">DEBUGGING:</p>
              <p className="text-xs break-all">
                NEXT_PUBLIC_API_URL is: {process.env.NEXT_PUBLIC_API_URL || "NOT SET"}
              </p>
            </div>
            ...
            {apiStatus === 'offline' && (
              <div className="mt-4 p-3 bg-destructive/10 border border-destructive/30 rounded-md text-destructive">
                <p className="font-medium">Detection server is offline</p>
                <p className="text-sm">The backend API could not be reached. Trying to connect to: {API_URL}</p>
              </div>
            )}
          </div>
